  ...
  <div id="ar-container">
    <div class="mindar-container">
      <div class="mindar-scene">
        <a-scene mindar-image="imageTargetSrc: /targets/castillo.mind;" embedded color-space="sRGB"
          ...
          <a-entity mindar-image-target="targetIndex: 0">
            ...
            <a-plane position="0 -0.4 0.1" width="1.4" height="0.4" color="#ffffff" opacity="0.9">
              <a-text value="Año 1593\nAquí los isleños repelieron a Francis Drake..." color="black" align="center"
                position="0 0 0.1" width="1.2" scale="1.5 1.5 1"></a-text>
            </a-plane>
          </a-entity>

          <a-entity>
            <a-plane color="yellow" position="0 -0.8 0.1" width="0.8" height="0.2"></a-plane>
            <a-text value="Escuchar historia 🔊" position="0 0 0.3" scale="2 2 1" color="black" align="center"
              width="4" />
